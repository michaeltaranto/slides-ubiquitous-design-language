...
var Controls = (0, _radium2.default)(_class = function (_Component) {
  ...
  Controls.prototype.render = function render() {
    return (0, _jsx3.default)("div", {}, void 0, this.props.currentSlide !== 0 && (0, _jsx3.default)("button", {
      type: "button",
    ...
    }, "prevIcon", _ref)), this.props.currentSlide < this.props.totalSlides - 1 && (0, _jsx3.default)("button", {
      type: "button",
